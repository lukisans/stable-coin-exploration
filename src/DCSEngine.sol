...
contract DCSEngine is ReentrancyGuard {
    ...
    // ════════════════════════════════════════ STATE VARIABLES ════════════════════════════════════════
    mapping(address token => address priceFeed) private s_priceFeeds; // Maps token to its price feed
    mapping(address user => mapping(address token => uint256 amount)) private s_collateralDeposited; // User collateral deposits
    mapping(address user => uint256 amountDscMinted) private s_DSCMinted; // DSC minted by user
